package org.kd.dhk.widget.segmentView;
...
//		this.setLayoutParams(new LinearLayout.LayoutParams(dp2Px(getContext(), 60), LinearLayout.LayoutParams.WRAP_CONTENT));
    ...
    textView1.setBackgroundResource(R.drawable.segment_left_sele);
    textView2.setBackgroundResource(R.drawable.segment_right_sele);
    textView3.setBackgroundResource(R.drawable.segment_right_sele);
